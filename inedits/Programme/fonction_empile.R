...
ined_empile = function(
  ...
  pal_oppose5       = c("#775e8a","#bca9c9","#d1d1d1","#eba8a4","#ea6058")
  pal_oppose6       = c("#775e8a","#a993b9","#d2c3db","#eba8a4","#e88882","#ea6058")
  pal_oppose7       = c("#775e8a","#a993b9","#d2c3db","#d1d1d1","#eba8a4","#e88882","#ea6058")
  ...
  if( is.null(var_couleur_pos) == F) {
    ...
    fill_color = case_when(
      ...
      palette == "orange_inv"                    ~ rev(pal_ordre_orange[ceiling(3.8-(n_moda/2)):floor(3.8+(nmoda/2))]),
