...
Il n'est plus nécessaire d'utiliser la fonction `ined_export()`, les fonctions de création de graphiques proposent désormais une option pour enregistrer directement les graphiques au format .pdf (voir plus bas), et elles affichent dans Rstudio la "vraie" version du graphique.


:::


4) Cliquer-glisser l'image .pdf dans la fiche  
...
- [**export** : TRUE ou FALSE]{style="color:#b34b4f;"} ; si TRUE : enregistre l'image au format .pdf, si FALSE : affiche uniquement le graphique  
- [**fichier** : chemin et nom du fichier .pdf à enregistrer]{style="color:#b34b4f;"}, par défaut "graphique".  
